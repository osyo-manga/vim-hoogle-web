...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hoogle_web#Branc#Job#import() abort
  ...
  execute join(['function! vital#_hoogle_web#Branc#Job#import() abort', printf("return map({'start': '', 'new': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
...
function! s:job.get_job()
	return self.is_run() ? self.__id : v:null
endfunction


function! s:job.get_channel()
	return job_getchannel(self.get_job())
endfunction
