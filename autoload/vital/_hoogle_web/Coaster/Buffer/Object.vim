...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hoogle_web#Coaster#Buffer#Object#import() abort
  ...
  execute join(['function! vital#_hoogle_web#Coaster#Buffer#Object#import() abort', printf("return map({'setbufline_if_python': '', 'setbufline_if_python3': '', 'setbufline_if_ruby': '', 'make': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
