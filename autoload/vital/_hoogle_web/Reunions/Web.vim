...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_hoogle_web#Reunions#Web#import() abort
    return map({'_vital_depends': '', 'parse_result': '', 'build_get_command': '', 'make_post_process': '', 'make_get_process': '', 'build_post_command': '', '_vital_loaded': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_hoogle_web#Reunions#Web#import() abort', printf("return map({'_vital_depends': '', 'parse_result': '', 'build_get_command': '', 'make_post_process': '', 'make_get_process': '', 'build_post_command': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
